...
var css = '.iedie-wrapper div{border:0 none;margin:0;padding:0;}'+
    ...
    '.iedie-browser-img{width:70px;height:60px;float:left;background-image:url(//static.bitmoe.cn/iewarning/1.2/recommended-browsers.jpg);background-repeat:no-repeat;}'+
...
var hint = '<p>尊敬 <b>比特萌</b> 用户，您好：<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;因本站采用了最新 HTML5 技术，您正在使用的浏览器可能不能很好的浏览本站，继续使用此浏览器访问本站，您可能会遇到页面样式错乱及某些功能无法正常使用的情况；另外老旧版本的浏览器也很可能存在安全问题，可能会影响您在网上浏览或使用网银时的信息安全，请您尽快更换最新的浏览器。</p><p>以下是我们为您推荐的几款兼顾访问速度、兼容性与安全性的常用浏览器：</p>';
if (typeof IEDIE_HINT === 'string') {
    hint = IEDIE_HINT;
    delete IEDIE_HINT;
}
document.write('<div id="iedie-wrapper" class="iedie-wrapper"><div id="iedie-bg"></div><div id="iedie-modal-wrapper"><div id="iedie-modal"><div class="iedie-title-wrapper"><a class="iedie-close" onclick="__iedie_close()" href="javascript:;">&times;&nbsp;关闭</a><div class="iedie-title">致用户的一封信</div><div class="iedie-clear"></div></div><div class="iedie-line"></div><div class="iedie-body">'+
    hint+
    ...
    '</div><a class="iedie-close" onclick="__iedie_close()" href="javascript:;">我已了解，点击继续访问 &gt;&gt;</a><br /><div style="text-align: right;"><br /><b>深圳比特萌信息技术有限公司 致上<br />2016年10月30日</b></div><div class="iedie-clear"></div></div></div></div></div>'+
    '');
